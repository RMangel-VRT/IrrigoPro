...
export const companies = pgTable("companies", {
  ...
  // Task #1865 — Seasonal Budget Model. Per-company season curve stored as
  // JSON array of {month, percent} objects. The default is the standard
  // Apr–Oct irrigation season: 0/10/20/20/20/20/10 summing to 100%.
...
export const customers = pgTable("customers", {
  ...
  // Task #1865 — Seasonal Budget Model. annualBudgetGoal replaces the flat
  // monthlyBudgetCap / annualBudgetCap as the single source of truth for
  // budget planning. budgetSeasonCurveOverride lets a customer have a
  // different season distribution than the company default.
  // The old cap columns are intentionally NOT dropped here — they will be
  // removed in a later cleanup migration after production verification.
...
// One row per customer per year/month. Generated by generateBudgetMonths()
// from the annual goal + curve. Rows with isManualOverride=true were set by
// a manager directly and are preserved across regenerations.
